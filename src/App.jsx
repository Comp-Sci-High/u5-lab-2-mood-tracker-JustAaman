...
import { useState } from "react"; // 3. import useState from react
      ...
      <section className="card">
        ...
        <div className="tracker-grid">
          <div className="tracker-box">
            ...
            <button
              className="btn"
              onClick={handleHappy}// 11. Connect this button to handleHappy using onClick
            >
              Change Mood to Happy 🙂
            </button>
          ...
          <div className="tracker-box">
            ...
            <button
              className="btn"
              onClick={handleEnergyUp}// 13. Connect this button to handleEnergyUp using onClick
            >
              Increase Energy ⚡
            </button>
        ...
        <button
          ...
          onClick={handleReset}// 15. Connect this button to handleReset using onClick
        >
          Reset Tracker
        </button>
        ...
        <button
          className="btn secondary"
          onClick={handleSchoolMode}// 16. Connect this button to handleSchoolMode using onClick
        >
          Toggle School Mode
        </button>
